...
export const PhotoIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="m2.25 15.75 5.159-5.159a2.25 2.25 0 0 1 3.182 0l5.159 5.159m-1.5-1.5 1.409-1.409a2.25 2.25 0 0 1 3.182 0l2.909 2.909m-18 3.75h16.5a1.5 1.5 0 0 0 1.5-1.5V6.75a1.5 1.5 0 0 0-1.5-1.5H3.75a1.5 1.5 0 0 0-1.5 1.5v12.909a1.5 1.5 0 0 0 1.5 1.5Zm4.708-2.876a.75.75 0 1 1-1.06 1.06.75.75 0 0 1 1.06-1.06Zm9.47-9.47a.75.75 0 1 1-1.06 1.06.75.75 0 0 1 1.06-1.06Z" />
  </svg>
);
...
export const SwatchIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9.53 16.122a3 3 0 0 0-3.035 3.678 3 3 0 0 1-5.941-.333c0-2.143 1.107-4.045 2.805-5.482a2.999 2.999 0 0 0 .728-3.412 6.518 6.518 0 0 1 .718-6.322 10.187 10.187 0 0 0-1.077 10.37 8.277 8.277 0 0 0 5.802 1.5Z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M7.188 2.239a4.49 4.49 0 0 1 4.54 4.484V24h12V4.499c0-2.485-2.015-4.499-4.5-4.499H7.188Z" />
  </svg>
);

export const TypeIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 21 15.75 9.75 21 21m-9-3h7.5M3 5.621a4.847 4.847 0 0 1 6-.371m0 0c1.12.714 1.714 1.49 1.714 1.49l2.25 2.25M3 5.621v12.75c0 .621.504 1.125 1.125 1.125H9.75M3 5.621a4.847 4.847 0 0 1 1.59-3.477M9.75 19.5a4.847 4.847 0 0 1-6-.371" />
  </svg>
);
